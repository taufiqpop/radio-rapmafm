<?= $this->extend('home/events/rapmafest10/templates/index'); ?>
...
<main id="main" style="background-image:url(events/rapmafest10/img/mentahan/BG\ NEW.png);background-size: cover;">
  <!-- ======= About Section ======= -->
  <section id="about" class="about">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        <div class="col-md-6">
          <img src="<?= base_url(); ?>events/rapmafest10/img/Icon/kelas online.png" style="float: left;width: 17%;">
        ...
        <div class="col-md-5">
          <img src="<?= base_url(); ?>events/rapmafest10/img/Icon/consert.png" style="float: left;width: 17%;">
  ...
  <section id="prosedur" class="portfolio">
    <div class="container" data-aos="fade-up">
      <div class="section-header">
        ...
        <img src="<?= base_url(); ?>events/rapmafest10/img/mentahan/procedur.png" style="width:100%;">
      </div>
    </div>
  </section>

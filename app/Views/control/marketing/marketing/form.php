...
<!-- Form Divisi Marketing -->
<div class="container-fluid">
    <div class="row">
        <div class="col-8">
            <h1 class="h3 mb-4 text-gray-800">Form Add Data Timeline Divisi Marketing</h1>
            ...
            <form action="<?= base_url(); ?>marketing/insert" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <select name="subdivisi">
                            ...
                            <option value="Marketing On Air">Marketing On Air</option>
                            <option value="Marketing Off Air">Marketing Off Air</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-7">
                        <a href="<?= base_url(); ?>control/marketing" class="btn btn-dark mb-1">Back</a>

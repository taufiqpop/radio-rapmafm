                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php foreach ($marketing as $index => $timeline) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php if (in_groups(['Admin', 'MM'])) : ?>
                                            <td>
                                                <a href="<?= base_url(); ?>control/marketing/edit/<?= $timeline['id']; ?>" class="btn btn-warning mb-1"><i class="fas fa-edit"></i></a>
                                                <form action="<?= base_url(); ?>control/marketing/<?= $timeline['id']; ?>" method="post" class="d-inline">
                                                    <?= csrf_field(); ?>

...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Detail Program</h1>
            ...
            <div class="col-lg-12">
                <div class="card mb-3" style="max-width: 1000px;">
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-5">
                            <!-- Images -->
                            <img src="<?= base_url(); ?>img/program/<?= $data->images ?>" class="card-img detail-img img-thumbnail">
                            ...
                            <center>
                                ...
                                <div class=" container tombol-detail">
                                    <a href="<?= base_url(); ?>control/program" class="btn btn-dark col-2"><i class="fas fa-arrow-left"></i></a>
                                    <a href="<?= base_url(); ?>control/program/edit/<?= $siaran['id']; ?>" class="btn btn-warning col-2"><i class="fas fa-edit"></i></a>

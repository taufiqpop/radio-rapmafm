...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h1 class="h3 mb-4 text-gray-800">Data Umum</h1>
            <?php if (in_groups(['Admin', 'MU'])) : ?>
                <a href="<?= base_url(); ?>control/umum/form" class="btn btn-primary">Add Timeline Divum</a>
                <br><br>
            <?php endif; ?>
                            ...
                            <tbody>
                                <?php foreach ($umum as $index => $ads) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php if (in_groups(['Admin', 'MU'])) : ?>
                                            <td>
                                                <a href="<?= base_url(); ?>control/umum/edit/<?= $ads['id']; ?>" class="btn btn-warning mb-1"><i class="fas fa-edit"></i></a>
                                                <form action="<?= base_url(); ?>control/umum/<?= $ads['id']; ?>" method="post" class="d-inline">
                                                    <?= csrf_field(); ?>

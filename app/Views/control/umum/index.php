...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h1 class="h3 mb-4 text-gray-800">Timeline Divisi Umum</h1>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php foreach ($umum as $index => $timeline) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php if (in_groups(['Admin', 'MU'])) : ?>
                                            <td>
                                                <a href="<?= base_url(); ?>control/umum/edit/<?= $timeline['id']; ?>" class="btn btn-warning mb-1"><i class="fas fa-edit"></i></a>
                                                <form action="<?= base_url(); ?>control/umum/<?= $timeline['id']; ?>" method="post" class="d-inline">
                                                    <?= csrf_field(); ?>

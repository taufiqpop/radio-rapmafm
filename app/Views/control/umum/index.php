                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php foreach ($umum as $index => $kepen) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php if (in_groups(['Admin', 'MU'])) : ?>
                                            <td>
                                                <a href="<?= base_url(); ?>control/umum/edit/<?= $kepen['id']; ?>" class="btn btn-warning mb-1"><i class="fas fa-edit"></i></a>
                                                <form action="<?= base_url(); ?>control/umum/<?= $kepen['id']; ?>" method="post" class="d-inline">
                                                    <?= csrf_field(); ?>

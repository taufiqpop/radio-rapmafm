...
<!-- List Workshop Broadcast -->
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h1 class="h3 mb-4 text-gray-800">Data Workshop Broadcast</h1>
            <?php if (in_groups(['Admin', 'MP', 'HRD'])) : ?>
                <a href="<?= base_url(); ?>control/workshopbroadcast/form" class="btn btn-primary">Add Workshop Broadcast</a>
                <br><br>
            <?php endif; ?>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php foreach ($workshopbroadcast as $index => $ads) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php if (in_groups(['Admin', 'MP', 'HRD'])) : ?>
                                            <td>
                                                <a href="<?= base_url(); ?>control/workshopbroadcast/edit/<?= $ads['id']; ?>" class="btn btn-warning mb-1"><i class="fas fa-edit"></i></a>
                                                <form action="<?= base_url(); ?>control/workshopbroadcast/<?= $ads['id']; ?>" method="post" class="d-inline">
                                                    <?= csrf_field(); ?>
                        ...
                        <!-- Pagers -->
                        <?= $pager->links('workshopbroadcast', 'data_pagination'); ?>
                    </div>
                </div>
            </div>
            <!-- End Table -->

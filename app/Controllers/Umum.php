...
class Umum extends BaseController
{
    ...
    public function insert()
    {
        ...
        session()->setFlashdata('pesan', 'Data Umum Berhasil Ditambahkan!');
    ...
    public function update($id)
    {
        ...
        session()->setFlashdata('pesan', 'Data Umum Berhasil Diubah!');
    ...
    public function delete($id)
    {
        ...
        session()->setFlashdata('pesan', 'Data Umum Berhasil Dihapus!');
